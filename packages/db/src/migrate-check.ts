...
const REQUIRED_NON_NULL_TEXT_COLUMNS = [
  ...
  ["keyword_governance_suggestion_generation_runs", "generation_version"],
  ["keyword_governance_suggestion_generation_runs", "prompt_set_version"],
  ["keyword_governance_suggestion_generation_runs", "input_hash"],
  ["keyword_governance_suggestion_invocation_attempts", "provider"],
  ["keyword_governance_suggestion_invocation_attempts", "model"],
  ["keyword_governance_suggestion_invocation_attempts", "prompt_set_version"],
  ["keyword_governance_suggestion_invocation_attempts", "input_hash"],
  ["keyword_governance_suggestion_invocation_attempts", "status"],
  ["keyword_review_suggestions", "suggestion_version"],
  ["keyword_review_suggestions", "generation_version"],
  ["keyword_review_suggestions", "prompt_set_version"],
  ["keyword_review_suggestions", "input_hash"],
  ["keyword_review_suggestions", "output_hash"],
  ["keyword_review_suggestions", "suggested_status"],
  ["keyword_review_suggestions", "suggested_mapping_decision"],
  ["keyword_review_suggestions", "suggested_reason"],
  ["keyword_review_suggestions", "intent_authority"],
  ["keyword_review_suggestions", "status"],
] as const;
