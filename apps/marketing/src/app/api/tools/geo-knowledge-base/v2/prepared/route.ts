// @input -- authenticated same-origin GEO v2 prepared request
...
import { handleGeoKbPreparedRead } from "../../../../../../lib/geo-tools/kb-prepared-handler.ts";
import { DEFAULT_GEO_KB_V2_RUNTIME } from "../../../../../../lib/geo-tools/kb-v2-runtime.ts";

export const runtime = "nodejs";
export const maxDuration = 30;
export function POST(request: Request): Promise<Response> {
  return handleGeoKbPreparedRead(request, DEFAULT_GEO_KB_V2_RUNTIME.prepared);
}
