...
// @output -- freezes the working copy and derives its question set, or one bounded private error
...
export async function POST(request: Request): Promise<Response> {
  return handleGeoKbFreeze(request, DEFAULT_GEO_KB_HANDLER_DEPENDENCIES);
}
