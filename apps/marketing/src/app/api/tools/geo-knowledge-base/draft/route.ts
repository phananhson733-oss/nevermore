...
// @output -- saves the working copy under an optimistic version, or one bounded private error
...
export async function POST(request: Request): Promise<Response> {
  return handleGeoKbSaveDraft(request, DEFAULT_GEO_KB_HANDLER_DEPENDENCIES);
}
