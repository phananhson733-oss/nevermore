...
describe("GEO knowledge pack assembler", () => {
  ...
  it.each(["3.5 seats are available.", "3% discount is available.", "$3 seats are available.", "₩3 seats are available.", "3/10 seats are available."])("does not admit an accepted numeric fact from %s", excerpt => {
