...
export const GEO_BRIEF_SYSTEM_PROMPT = [
  ...
  "- Never invent a Q id. Return the Q ids you were given, unchanged.",
  "- You may add a must-answer item only when the question obviously requires",
  "  it and no given subtopic covers it. Number added items M1, M2, ... M12",
  "  in order; never use that M namespace for an observed item.",
