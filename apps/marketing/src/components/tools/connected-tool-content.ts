...
const EN: Record<ConnectedTool, ConnectedToolContent> = {
  ...
  "traffic-drop-diagnosis": {
    ...
    description:
      "Compare two periods of Search Console performance to identify which pages, queries, or segments changed before deciding what to fix.",
    sourceLabel: "Requires a Google Search Console connection",
    sourceDetail:
      "GenGrowth uses read-only Search Console access and asks you to review the selected property and comparison window.",
