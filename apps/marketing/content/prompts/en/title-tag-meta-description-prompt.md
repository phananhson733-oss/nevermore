...
| --- | --- | --- | --- | --- | --- | --- |
| /features/rota-scheduling | Staff Rota Software with Clash Warnings \| Shiftmark | 51 | Build the week's rota by dragging shifts, publish it to staff phones, and get a warning when a shift clashes with the availability someone has declared. | 152 | Replace | The current title is the nav label, and the current description is the same sentence sitting on /features/timesheets |
