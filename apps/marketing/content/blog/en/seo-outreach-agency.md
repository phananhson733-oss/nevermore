---
title: How to Judge an SEO Outreach Agency on Relevance, Not Link Count
excerpt: An SEO outreach agency is a service that earns links to your site by pitching real editors, writers, and site owners — and the ones worth hiring win placements on topically relevant pages through editorial merit, not by buying or networking links into private blog farms.
...
1. **Where do the links land?** Topically relevant pages your buyers actually read, or filler sites that exist only to host links.
2. **How were they won?** A genuine pitch an editor accepted, or a transaction the agency would rather not describe.
3. **What is the reply rate?** A real outreach motion produces a measurable funnel; a link-inventory motion produces a spreadsheet of URLs with no funnel behind it.
...
1. **"More links is always better."** Past a point, more low-relevance links add risk, not authority. One relevant placement can outperform ten filler links.
...
1. **Ask for five recent live placements and read them.** If the pages are off-topic, thin, or obviously built to host links, the relevance is not there regardless of the count.
...
1. **Define your relevance map first.** List the topics, categories, and publications your buyers already trust. This is the target list every placement gets measured against.
