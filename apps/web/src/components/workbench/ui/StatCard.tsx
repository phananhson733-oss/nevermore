 ...
 * threshold applies (measured on white: fuchsia-500 3.46:1, emerald-600 3.77:1,
 * amber-600 3.19:1). None of them may be reused for body copy. `fuchsia` is the
 * AI-mention tone, matching the rail's GEO dot; the prototype's violet-500 is a
 * deliberate deviation (裁决 Q19) and is not offered here, so no view can pick
 * it and split one concept across two colours.
 */
...
export function StatCard({
  ...
  const body = (
    <>
      ...
      <p className="mt-2 text-sm font-medium text-slate-600 group-hover:text-slate-900">
        {label}
      </p>
