...
const CLEAR_COPY = {
  en: {
    ...
    body: "This clears the site's GSC rows, keyword library, saved artifacts and site profile in this browser, including anything you added after loading the sample.",
    cancel: "Cancel",
  ...
  "zh-CN": {
    ...
    chipAfter: "示例数据",
    title: "清除示例数据？",
    body: "会清掉这个站点在本浏览器里的 GSC 行、词库、产物筐与站点档案，包括载入示例之后你自己加的内容。",
    cancel: "取消",
    confirm: "清除示例",
  },
} as const;
