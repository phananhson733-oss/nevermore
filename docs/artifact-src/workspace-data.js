(function attachGenGrowthWorkspace(global) {
  ...
  const enums = {
    ...
    auditEventType: {
      ...
      KEYWORD_REVIEWED: 'keyword_reviewed',
  ...
  const dataset = {
    ...
    keywords: [
      ...
      { id: 'kw-onboarding-checklist', projectId: 'prj-relayops-us', text: 'customer onboarding checklist', sourceKind: 'gsc_unexpected', sourceRefs: ['src-gsc'], status: 'monitoring', clusterId: 'clu-onboarding', mappedUrlId: 'url-checklist', ctaId: 'conv-guide-download', intent: 'informational', market: 'US', volume: 1900, difficulty: 34, currentRank: 9.6 },
      {
        id: 'kw-reduce-ttv',
        projectId: 'prj-relayops-us',
        text: 'reduce customer time to value',
        sourceKind: 'community_voc',
        sourceRefs: ['src-customer-notes'],
        status: 'opportunity',
        governanceStatus: 'candidate',
        governanceRevision: 0,
        clusterId: 'clu-measurement',
        mappedUrlId: 'url-time-to-value',
        mappingDecision: 'existing_page',
        ctaId: 'conv-workflow-review',
        ...
        currentRank: 21.1,
        pendingSuggestion: {
          id: 'kw-suggestion-reduce-ttv-v0',
          suggestionVersion: 'keyword-governance-suggestion.v0',
          state: 'pending_ready',
          ...
          mappingDecision: 'existing_page',
          mappedUrlId: 'url-time-to-value',
          reason: '该建议使用了已不受支持的旧建议版本，必须刷新后才能审核。',
          limitation: null,
          lineageSummary: '产品画像 v4 · 旧版建议场景记录',
          scenarioOnly: true,
        },
      },
      ...
      {
        id: 'kw-onboarding-metrics',
        projectId: 'prj-relayops-us',
        text: 'customer success onboarding metrics',
        sourceKind: 'community_voc',
        sourceRefs: ['src-customer-notes'],
        status: 'review',
        governanceStatus: 'candidate',
        ...
        currentRank: 13.2,
        pendingSuggestion: {
          id: 'kw-suggestion-onboarding-metrics-v1',
          ...
          mappingDecision: 'existing_page',
          mappedUrlId: 'url-time-to-value',
          reason: '已确认的客户价值衡量 Topic 与现有 Time to Value 页面能够承接该查询。',
          limitation: null,
          lineageSummary: '产品画像 v4 · 已发布 Topic Map · 客户访谈场景快照',
          scenarioOnly: true,
        },
      },
      {
        id: 'kw-ai-assistant',
        projectId: 'prj-relayops-us',
        text: 'AI customer onboarding assistant',
        sourceKind: 'trend_signal',
        sourceRefs: ['src-serp'],
        status: 'opportunity',
        governanceStatus: 'candidate',
        governanceRevision: 2,
        clusterId: 'clu-onboarding',
        mappedUrlId: null,
        ...
        currentRank: null,
        pendingSuggestion: {
          id: 'kw-suggestion-ai-assistant-v1',
          suggestionVersion: 'keyword-governance-suggestion.v1',
          ...
          mappedUrlId: null,
          reason: '趋势信号与已确认的客户上线 JTBD 一致，但当前来源没有可用的搜索意图权威。',
          limitation: '搜索意图权威不可用，需要人工补充后再保存审核决定。',
          lineageSummary: '产品画像 v4 · 已发布 Topic Map · SERP 场景快照',
          scenarioOnly: true,
        },
      },
      ...
      {
        id: 'kw-handoff-checklist',
        projectId: 'prj-relayops-us',
        text: 'onboarding handoff checklist',
        sourceKind: 'manual_csv',
        sourceRefs: ['src-manual-profile'],
        status: 'new',
        governanceStatus: 'candidate',
        governanceRevision: 0,
        clusterId: 'clu-onboarding',
        ...
        currentRank: null,
        pendingSuggestion: {
          id: 'kw-suggestion-handoff-checklist-v1',
          suggestionVersion: 'keyword-governance-suggestion.v1',
          state: 'pending_ready',
          expectedGovernanceRevision: 0,
          status: 'approved',
          ...
          mappingDecision: 'new_asset',
          mappedUrlId: null,
          reason: 'CSV 入库词与已确认的客户上线交接 JTBD、信息型意图和“客户上线”Topic 一致；当前没有可复用页面，建议创建新内容资产。',
          limitation: null,
          lineageSummary: '产品画像 v4 · 已发布 Topic Map · CSV 场景记录',
          scenarioOnly: true,
        },
      },
    ],
