...
-- BEGIN EXACT ORDERED MIGRATION 0049_projection_batch_writes.sql
BEGIN;
...
COMMIT;
-- END EXACT ORDERED MIGRATION 0049_projection_batch_writes.sql

-- BEGIN EXACT ORDERED MIGRATION 0050_product_profile_keyword_lineage.sql
BEGIN;
...
COMMIT;
-- END EXACT ORDERED MIGRATION 0050_product_profile_keyword_lineage.sql
