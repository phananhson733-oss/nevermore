...
-- BEGIN EXACT ORDERED MIGRATION 0036_missing_analytics_site_page_lineage.sql
BEGIN;
...
COMMIT;
-- END EXACT ORDERED MIGRATION 0036_missing_analytics_site_page_lineage.sql

-- BEGIN EXACT ORDERED MIGRATION 0037_dataforseo_search_landscape_v2.sql
BEGIN;
...
COMMIT;
-- END EXACT ORDERED MIGRATION 0037_dataforseo_search_landscape_v2.sql

-- BEGIN EXACT ORDERED MIGRATION 0038_optional_source_onboarding.sql
BEGIN;
...
COMMIT;
-- END EXACT ORDERED MIGRATION 0038_optional_source_onboarding.sql

-- BEGIN EXACT ORDERED MIGRATION 0039_product_profile_competitor_provenance.sql
BEGIN;
...
COMMIT;
-- END EXACT ORDERED MIGRATION 0039_product_profile_competitor_provenance.sql

-- BEGIN EXACT ORDERED MIGRATION 0040_internal_link_opportunity_coverage.sql
BEGIN;
...
COMMIT;
-- END EXACT ORDERED MIGRATION 0040_internal_link_opportunity_coverage.sql

-- BEGIN EXACT ORDERED MIGRATION 0041_product_profile_default_competitors.sql
BEGIN;
...
COMMIT;
-- END EXACT ORDERED MIGRATION 0041_product_profile_default_competitors.sql
...
-- BEGIN EXACT ORDERED MIGRATION 0044_dataforseo_backlinks.sql
BEGIN;
...
COMMIT;
-- END EXACT ORDERED MIGRATION 0044_dataforseo_backlinks.sql

-- BEGIN EXACT ORDERED MIGRATION 0045_dataforseo_backlink_target_lineage.sql
BEGIN;
...
COMMIT;
-- END EXACT ORDERED MIGRATION 0045_dataforseo_backlink_target_lineage.sql

-- BEGIN EXACT ORDERED MIGRATION 0046_workspace_plan_tier.sql
BEGIN;
...
COMMIT;
-- END EXACT ORDERED MIGRATION 0046_workspace_plan_tier.sql

-- BEGIN EXACT ORDERED MIGRATION 0047_dataforseo_competitor_metrics.sql
BEGIN;
...
COMMIT;
-- END EXACT ORDERED MIGRATION 0047_dataforseo_competitor_metrics.sql

-- BEGIN EXACT ORDERED MIGRATION 0048_projection_batch_writes.sql
BEGIN;
...
COMMIT;
-- END EXACT ORDERED MIGRATION 0048_projection_batch_writes.sql

-- BEGIN EXACT ORDERED MIGRATION 0049_product_profile_keyword_lineage.sql
BEGIN;
...
COMMIT;
-- END EXACT ORDERED MIGRATION 0049_product_profile_keyword_lineage.sql
